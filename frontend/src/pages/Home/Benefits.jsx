  ...
  return (
    <>
      <div className="text-center mt-10">
        ...
        <p className="text-lg w-3/4 mx-auto pb-6 text-gray-800">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center py-10 px-4 lg:px-12">
        {/* Image Section */}
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          <h1 className="font-semibold text-4xl text-gray-800 mb-4">
            Rent a car now <span className="text-amber-500">in your hand</span>.
            Try it now!
          </h1>
